...
<%@include file="../includes/navbar.jsp" %>
		...
		<div class="box generalbox center clearfix p-y-1">
			<div class="no-overflow">
				...
				<ul>
					...
					<li>Soporte para expresiones que pueden establecer valores y expresiones que pueden invocar métodos</li>
	...
	<section class="p-3 mb-3 bg-light shadow">
		...
		<p>Array colores es null ? ${pageScope.colores == null}</p>
		<p>Array tamaño = ${pageScope.colores.size()}</p>

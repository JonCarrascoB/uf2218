...
<%@include file="../includes/navbar.jsp" %>
	...
	<h1>Ejemplo de Servlet GET y POST</h1>
	<p></p>
	...
	<a href="getpost?nombre=Manolo" class="btn btn-outline-primary">Peticion GET con ?nombre=Manolo</a>
	...
	<p>Siempre se envia mediante una etiqueta form</p>
